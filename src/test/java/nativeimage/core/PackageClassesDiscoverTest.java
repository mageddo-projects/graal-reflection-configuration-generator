...
class PackageClassesDiscoverTest {
	...
	private PackageClassesDiscover packageClassesDiscover;

	@BeforeEach
	void before(){
		this.packageClassesDiscover = new PackageClassesDiscover();
	}
	...
	void mustMatchInnerClass(){
		...
		// act
		final Set<String> classes = this.packageClassesDiscover.discover(innerClassElement, "com.acme");

		// assert
		assertEquals("[com.acme.UpperClass$InnerClass]", classes.toString());
	}
}
